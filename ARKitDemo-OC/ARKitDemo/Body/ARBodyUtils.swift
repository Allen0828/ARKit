...
class ARBodyUtils {
    ...
    static var selectedJointNames:[ARSkeleton.JointName] = [.head, .leftFoot, .rightFoot, .rightHand, .leftHand, .leftShoulder, .rightShoulder, .init(rawValue: "left_forearm_joint"), .init(rawValue: "right_forearm_joint"), .init(rawValue: "left_leg_joint"), .init(rawValue: "right_leg_joint"), .init(rawValue: "left_upLeg_joint"), .init(rawValue: "right_upLeg_joint"), .init(rawValue: "left_toes_joint"), .init(rawValue: "right_toes_joint")]
